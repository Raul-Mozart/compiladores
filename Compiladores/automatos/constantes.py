...
# Caracteres ASCII imprimíveis (espaço até ~) + tab/quebra de linha + UTF-8 comuns
# Incluindo caracteres acentuados (à-ÿ) e outros símbolos UTF-8 comuns
...
TOKENS_COMUNS = {
    ...
    "FLOAT": r"\d+\.\d+",
    # STRING: aspas duplas, permite escapes simples e caracteres UTF-8
    "STRING": r'\"(\\.|[^"\\])*\"',
